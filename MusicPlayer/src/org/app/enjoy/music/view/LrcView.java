...
public class LrcView extends View implements ILrcView{
	...
	public LrcView(Context context,AttributeSet attr){
		...
		mSeekLineTextSize = (int) mContext.getResources().getDimension(R.dimen.text_size_12);
		mMinSeekLineTextSize = (int) mContext.getResources().getDimension(R.dimen.text_size_10);;
		mMaxSeekLineTextSize = (int) mContext.getResources().getDimension(R.dimen.text_size_12);
		mLrcFontSize = (int) mContext.getResources().getDimension(R.dimen.text_size_16); 	// font size of lrc
		mMinLrcFontSize = (int) mContext.getResources().getDimension(R.dimen.text_size_12);
		mMaxLrcFontSize = (int) mContext.getResources().getDimension(R.dimen.text_size_22);
	}
